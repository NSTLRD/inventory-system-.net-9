...
namespace NewTest
{
    ...
    public class GetAllProductsQuery : Products.Interfaces.IRequest<IPagedResponse<IProductDto>> 
    {
        public int PageNumber { get; set; }
        public int PageSize { get; set; }
    }

    public class GetProductByIdQuery : Products.Interfaces.IRequest<IProductDto>
    {
    ...
    {
        private readonly Products.Interfaces.IMediator _mediator;
    ...
    {
        private Mock<Products.Interfaces.IMediator> _mediatorMock;
