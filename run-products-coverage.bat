@echo off
echo Ejecutando pruebas de ms-products con cobertura...

set projectPath=.\ms-products
set testProject=.\ms-products\NewTest
set outputDir=.\coverage-reports\products
