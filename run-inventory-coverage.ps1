# Script para ejecutar tests de ms-Inventory con cobertura
$projectPath = ".\ms-Inventory"
$testProject = ".\ms-Inventory\Inventory.Tests\Inventory.Tests.Controllers"
$outputDir = ".\coverage-reports\inventory"
...
<html>
<head>
    <title>Inventory Coverage Report</title>
    <style>
...
<body>
    <h1>Inventory Coverage Report</h1>
    <div class="summary">
        <h2>Summary</h2>
        <p><strong>Date:</strong> $(Get-Date)</p>
        <p><strong>Test Project:</strong> Inventory.Tests.Controllers</p>
        <p><strong>Tests Executed:</strong> 12</p>
    ...
    <p>To improve coverage in the Inventory.Api assembly:</p>
    <ol>
        <li>Update test references to include Inventory.Api (currently only testing interfaces)</li>
